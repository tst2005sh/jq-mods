jq_deps_better_from_entries_with_entries=''
jq_function_better_from_entries_with_entries='
...
'
jq_deps_pr2293="$jq_deps_better_from_entries_with_entries"
jq_function_pr2293="$jq_function_better_from_entries_with_entries"
